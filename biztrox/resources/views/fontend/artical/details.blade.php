...
@section('body')
    <section class="page-title overlay" style="background-image: url({{asset('/')}}fontend/images/background/page-title.jpg);">
        <div class="container">
            <div class="row">
            ...
            <div class="row">
                <div class="col-lg-8 py-100">
                    <div class="border rounded bg-white">
                        <img class="img-fluid w-100 rounded-top" src="{{asset($artical->artical_image)}}" alt="blog-image">
                        <div class="p-4">
                            <h3>{{$artical->artical_title}}</h3>
                            <ul class="list-inline d-block pb-4 border-bottom mb-3">
                                <li class="list-inline-item text-color">Posted By Admin</li>
                                <li class="list-inline-item text-color">On {{$artical->updated_at->format('d-M-y')}}</li>
                            </ul>
                            <p> {!! \Illuminate\Support\Str::words($artical->blog_description) !!}</p>
                        </div>
                    </div>
                    ...
                    <!-- comments -->
                    <div>
                        <h4 class="mb-20">Comments (1)</h4>
                        <!-- comment item -->
                        <div class="d-flex mb-4">
                            <div class="mr-3">
                                <img class="img-fluid rounded w-100" src="{{asset('/')}}fontend/images/blog/comment-1.jpg" alt="user-image">
                            </div>
...
{{--                        </div>--}}
                        ...
                        <div class="mb-50">
                            ...
                            @foreach($recentArticale as  $recent)

                            <div class="d-flex py-3 border-bottom">
                                <div class="mr-4">
                                    <a href="{{route('artical.details',['slug'=>$recent->slug])}}">
                                        <img class="rounded" src="{{asset($recent->artical_image)}}" style="height: 100px;width: 120px" alt="post-thumb">
                                    </a>
                                </div>
                                <div>
                                    <h6 class="mb-3">
                                        <a class="text-dark" href="{{route('artical.details',['slug'=>$recent->slug])}}">{{$recent->artical_title}}</a>
                                    </h6>
                                    <p class="meta">{{$recent->updated_at->format('D-m-y')}}</p>
                                </div>
                            </div>
