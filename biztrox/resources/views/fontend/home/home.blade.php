...
@section('body')
    ...
    <!-- about -->
    <section class="overlay" style="background-image: url({{asset('/')}}fontend/images/background/about-bg.jpg);">
        ...
        <div class="container">
            <div class="row justify-content-center">
                ...
                <div class="col-lg-4 col-sm-6 mb-4 mb-lg-0">
                    <div class="card mb-3">
                        <img class="card-img-top" height="200px" src="{{asset($artical->artical_image)}}" alt="news-thumbnail">
                        <div class="card-body p-0">
