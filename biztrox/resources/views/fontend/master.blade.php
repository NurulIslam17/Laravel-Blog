    ...
    <div class="swiper-container">
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
                <div class="slide-inner slide-bg-image" data-background="{{asset('/')}}fontend/images/banner/banner-1.jpg">
                    <div class="container">
            ...
            <!-- start swiper-slide -->
            <div class="swiper-slide">
                <div class="slide-inner slide-bg-image" data-background="{{asset('/')}}fontend/images/banner/banner-2.jpg">
                    <div class="container">
                        <div class="hero-content">
                            <h4 class="text-uppercase mb-1" data-swiper-parallax="300">We are here to</h4>
                            <h1 class="font-weight-bold mb-3" data-swiper-parallax="350">Planning Business</h1>
            ...
            <!-- start swiper-slide -->
            <div class="swiper-slide">
                <div class="slide-inner slide-bg-image" data-background="{{asset('/')}}fontend/images/banner/banner-3.jpg">
                    <div class="container">
                        <div class="hero-content">
            ...
            <!-- start swiper-slide -->
            <div class="swiper-slide">
                <div class="slide-inner slide-bg-image" data-background="{{asset('/')}}fontend/images/banner/banner-4.jpg">
                    <div class="container">
                        <div class="hero-content">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 align-self-center">
                <img class="img-fluid w-100" src="{{asset('/')}}fontend/images/chart.png" alt="chart">
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="row justify-content-center">
            ...
            <div class="col-lg-4 col-sm-6 mb-4 mb-lg-0">
                <div class="card">
                    <img class="card-img-top" src="{{asset('/')}}fontend/images/blog/blog-1.jpg" alt="news-thumbnail">
                    <div class="card-body p-0">
            ...
            <div class="col-lg-4 col-sm-6 mb-4 mb-lg-0">
                <div class="card">
                    <img class="card-img-top" src="{{asset('/')}}fontend/images/blog/blog-2.jpg" alt="news-thumbnail">
                    <div class="card-body p-0">
                        <div class="p-3 border-bottom">
                            <h6 class="text-primary">Dec 20, 2017</h6>
                            <a href="blog-single.html" class="h4 card-title font-primary text-dark">Cras sed elit sit
            ...
            <div class="col-lg-4 col-sm-6">
                <div class="card">
                    <img class="card-img-top" src="{{asset('/')}}fontend/images/blog/blog-3.jpg" alt="news-thumbnail">
                    <div class="card-body p-0">
                        <div class="p-3 border-bottom">
                            <h6 class="text-primary">Dec 20, 2017</h6>
                            <a href="blog-single.html" class="h4 card-title font-primary text-dark">Cras sed elit sit
...
<section class="bg-primary py-4">
    <div class="container">
        <div class="client-logo-slider align-self-center">
            <a href="#" class="text-center d-block outline-0 py-3 px-2"><img class="d-unset" src="{{asset('/')}}fontend/images/client-logo/client-logo-1-white.png" alt="client-logo"></a>
            <a href="#" class="text-center d-block outline-0 py-3 px-2"><img class="d-unset" src="{{asset('/')}}fontend/images/client-logo/client-logo-2-white.png" alt="client-logo"></a>
            <a href="#" class="text-center d-block outline-0 py-3 px-2"><img class="d-unset" src="{{asset('/')}}fontend/images/client-logo/client-logo-3-white.png" alt="client-logo"></a>
            <a href="#" class="text-center d-block outline-0 py-3 px-2"><img class="d-unset" src="{{asset('/')}}fontend/images/client-logo/client-logo-4-white.png" alt="client-logo"></a>
            <a href="#" class="text-center d-block outline-0 py-3 px-2"><img class="d-unset" src="{{asset('/')}}fontend/images/client-logo/client-logo-5-white.png" alt="client-logo"></a>
            <a href="#" class="text-center d-block outline-0 py-3 px-2"><img class="d-unset" src="{{asset('/')}}fontend/images/client-logo/client-logo-1-white.png" alt="client-logo"></a>
            <a href="#" class="text-center d-block outline-0 py-3 px-2"><img class="d-unset" src="{{asset('/')}}fontend/images/client-logo/client-logo-2-white.png" alt="client-logo"></a>
            <a href="#" class="text-center d-block outline-0 py-3 px-2"><img class="d-unset" src="{{asset('/')}}fontend/images/client-logo/client-logo-3-white.png" alt="client-logo"></a>
            <a href="#" class="text-center d-block outline-0 py-3 px-2"><img class="d-unset" src="{{asset('/')}}fontend/images/client-logo/client-logo-4-white.png" alt="client-logo"></a>
